...
cookie = input('\033[1;97mThêm Cookie Ins Tại Đây: ')


def banner():
    banner = f"""
\033[1;97m~ \033[1;92mTool : \033[1;97mTDS.X.Ins
\033[1;97m~ \033[1;92mEdit : \033[1;97mNguyễn Nhật Quyền
\033[1;97m~ \033[1;92mSupport Edit : \033[1;97mLê Minh Thuận (coder)
\033[1;97m~ \033[1;92mFacebook : \033[1;97mhttps://www.facebook.com/nhatquyen.artvn
\033[1;97m~ \033[1;92mZalo : \033[1;97m0792161421
\033[1;97m- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n"""
    for X in banner:
        sys.stdout.write(X)
        sys.stdout.flush()
...
try:
    choose = int(input('Chọn Chế Độ Ins: '))
    print(
        '\033[1;97m- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n')
except:
    ...
    while True:
        try:
            ...
            if len(listQuest['data']) == 0:
                print(f"{Fore.RED}[!]{Style.RESET_ALL} Nguyễn Nhật Quyền Đang Cày Xu Cho Bạn <3")
            else:
                ...
                if followUser:
                    ...
                    for i in range(5, -1, -1):
                        print(
                            f'\033[1;31m[\033[0;36m|\033[1;31m] \033[0;97mNNQcoderpro {i} •   ', end='\r')
                        time.sleep(0.25)
                        print(
                            f'\033[1;31m[\033[0;36m/\033[1;31m] \033[0;97mNNQcoderpro {i} ••    ', end='\r')
                        time.sleep(0.25)
